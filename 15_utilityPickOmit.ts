...
export function createArticle(data: ArticleCreate): Article {
  ...
  return {
    id: Math.floor(Math.random() * 100000), // ID généré simple
    createdAt: now,
    updatedAt: now,
    ...data,
  };
...
console.log(createArticle({ title: "New", content: "Article", author: "Jane" })); // { id: <generated>, title: "New", content: "Article", author: "Jane", createdAt: <now>, updatedAt: <now> }
