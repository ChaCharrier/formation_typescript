...
console.log(cloneUser(user)); // { id: <new>, name: "Alice", age: 30, active: true, createdAt: <same> }

console.log(createUserFromArray(["Bob", 25, false])); // équivalent à createUser("Bob", 25, false)
console.log(createUser("Bob", 25, false));
